<div x-data="{ canLoadMore: @entangle('canLoadMore') }" class="w-full h-full"
    @scroll.window.trottle="
        scrollTop = window.scrollY || window.scrollTop;
        divHeight = window.innerHeight||documentElement.clientHeight;
    ...
    <main class="grid lg:grid-cols-12 gap-8 md:mt-10 ">
                ...
                <ul class="flex overflow-x-auto scrollbar-hide items-center gap-2">
                    ...
                    @for ($i = 0; $i < 10; $i++)
                        <li class="flex flex-col justify-center w-20 gap-1 p-2">
                            <x-avatar wire:ignore story src="{{ getRandomAvatar() }}" class="h-14 w-14" />
        ...
        {{-- sugestions --}}
        <aside class="lg:col-span-4 lg:block p-4">
